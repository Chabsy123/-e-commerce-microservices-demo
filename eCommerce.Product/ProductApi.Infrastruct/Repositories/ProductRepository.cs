    ...
    internal class ProductRepository(ProductDbContext context) : IProduct
    {
        public async Task<Response> CreateAsync(Product entity)
        {
           try
            ...
            catch (Exception ex)
            {
                ...
                return new Response(false, "Error occurred while adding the product. Please try again later.");
            }
        }
        ...
        public async Task<Response> DeleteAsync(Product entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client
                return new Response(false, "Error occurred while deleting the product. Please try again later.");
            }
        }
        ...
        public async Task<Response> UpdateAsync(Product entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client
                return new Response(false, "Error occurred while updating the product. Please try again later.");
            }
        }
    }
}
